...
--
-- Name: linking; Type: SCHEMA; Schema: -; Owner: lmullen
--

CREATE SCHEMA linking;


ALTER SCHEMA linking OWNER TO lmullen;
...
--
-- Name: networks; Type: SCHEMA; Schema: -; Owner: lmullen
--

CREATE SCHEMA networks;


ALTER SCHEMA networks OWNER TO lmullen;

--
-- Name: output; Type: SCHEMA; Schema: -; Owner: lmullen
--

CREATE SCHEMA output;


ALTER SCHEMA output OWNER TO lmullen;
...
--
-- Name: to_delete; Type: SCHEMA; Schema: -; Owner: lmullen
--

CREATE SCHEMA to_delete;


ALTER SCHEMA to_delete OWNER TO lmullen;
...
--
-- Name: moml_citations; Type: TABLE; Schema: output; Owner: lmullen
--
...
ALTER TABLE output.moml_citations OWNER TO lmullen;

--
-- Name: moml_01_clean_cites_agg; Type: VIEW; Schema: linking; Owner: lmullen
--
...
ALTER VIEW linking.moml_01_clean_cites_agg OWNER TO lmullen;

--
-- Name: VIEW moml_01_clean_cites_agg; Type: COMMENT; Schema: linking; Owner: lmullen
--
...
--
-- Name: moml_02_nominate_vols; Type: VIEW; Schema: linking; Owner: lmullen
--
...
ALTER VIEW linking.moml_02_nominate_vols OWNER TO lmullen;

--
-- Name: moml_03_link_cite; Type: VIEW; Schema: linking; Owner: lmullen
--
...
CREATE VIEW linking.moml_03_link_cite AS
 SELECT n,
    ...
    cleaner_cite,
    altvol_cite,
    COALESCE(altvol_cite, cleaner_cite) AS cap_link_cite
   FROM linking.moml_02_nominate_vols;


ALTER VIEW linking.moml_03_link_cite OWNER TO lmullen;

--
-- Name: moml_04_cap_case; Type: VIEW; Schema: linking; Owner: lmullen
--
...
ALTER VIEW linking.moml_04_cap_case OWNER TO lmullen;

--
-- Name: moml_05_moml_to_cap; Type: MATERIALIZED VIEW; Schema: linking; Owner: lmullen
--
...
ALTER MATERIALIZED VIEW linking.moml_05_moml_to_cap OWNER TO lmullen;

--
-- Name: moml_06_treatise_to_case; Type: VIEW; Schema: linking; Owner: lmullen
--
...
ALTER VIEW linking.moml_06_treatise_to_case OWNER TO lmullen;
...
--
-- Name: schools_to_cases; Type: MATERIALIZED VIEW; Schema: networks; Owner: lmullen
--

CREATE MATERIALIZED VIEW networks.schools_to_cases AS
 SELECT s2w2v.school,
    s2w2v.school_state,
    s2w2v.region,
    s2w2v.course,
   ...
   FROM (((( SELECT tw.workid,
     ...
     LEFT JOIN linking.moml_06_treatise_to_case m6 ON ((s2w2v.psmid = m6.moml_treatise)))
     LEFT JOIN cap.cases c ON ((m6."case" = c.id)))
     LEFT JOIN cap.jurisdictions j ON ((c.jurisdiction = j.id)))
  WITH NO DATA;


ALTER MATERIALIZED VIEW networks.schools_to_cases OWNER TO lmullen;

--
-- Name: schools_to_textbooks; Type: VIEW; Schema: networks; Owner: lmullen
--

CREATE VIEW networks.schools_to_textbooks AS
...
ALTER VIEW networks.schools_to_textbooks OWNER TO lmullen;

--
-- Name: treatise_bibliocouple; Type: MATERIALIZED VIEW; Schema: networks; Owner: lmullen
--
...
ALTER MATERIALIZED VIEW networks.treatise_bibliocouple OWNER TO lmullen;

--
-- Name: top_reporters; Type: MATERIALIZED VIEW; Schema: output; Owner: lmullen
--
...
ALTER MATERIALIZED VIEW output.top_reporters OWNER TO lmullen;

--
-- Name: top_reporters_not_whitelisted; Type: VIEW; Schema: output; Owner: lmullen
--
...
ALTER VIEW output.top_reporters_not_whitelisted OWNER TO lmullen;

--
-- Name: cap_to_cap_citations; Type: MATERIALIZED VIEW; Schema: public; Owner: lmullen
--
...
ALTER MATERIALIZED VIEW public.cap_to_cap_citations OWNER TO lmullen;
...
--
-- Name: reporters_citation_to_cap_bak; Type: TABLE; Schema: to_delete; Owner: lmullen
--
...
ALTER TABLE to_delete.reporters_citation_to_cap_bak OWNER TO lmullen;
...
--
-- Name: moml_citations moml_citations_id_key; Type: CONSTRAINT; Schema: output; Owner: lmullen
--
...
--
-- Name: moml_citations moml_citations_pkey; Type: CONSTRAINT; Schema: output; Owner: lmullen
--
...
--
-- Name: moml_05_moml_to_cap_case_idx; Type: INDEX; Schema: linking; Owner: lmullen
--
...
--
-- Name: moml_05_moml_to_cap_moml_treatise_idx; Type: INDEX; Schema: linking; Owner: lmullen
--
...
--
-- Name: moml_05_moml_to_cap_moml_treatise_moml_page_idx; Type: INDEX; Schema: linking; Owner: lmullen
--
...
--
-- Name: schools_to_cases_case_idx; Type: INDEX; Schema: networks; Owner: lmullen
--

CREATE INDEX schools_to_cases_case_idx ON networks.schools_to_cases USING btree ("case");


--
-- Name: schools_to_cases_school_idx; Type: INDEX; Schema: networks; Owner: lmullen
--

CREATE INDEX schools_to_cases_school_idx ON networks.schools_to_cases USING btree (school);


--
-- Name: schools_to_cases_year_begin_idx; Type: INDEX; Schema: networks; Owner: lmullen
--

CREATE INDEX schools_to_cases_year_begin_idx ON networks.schools_to_cases USING btree (year_begin);


--
-- Name: schools_to_cases_year_end_idx; Type: INDEX; Schema: networks; Owner: lmullen
--

CREATE INDEX schools_to_cases_year_end_idx ON networks.schools_to_cases USING btree (year_end);
...
--
-- Name: SCHEMA linking; Type: ACL; Schema: -; Owner: lmullen
--

GRANT USAGE ON SCHEMA linking TO law_service;
GRANT ALL ON SCHEMA linking TO law_admin;
...
--
-- Name: SCHEMA output; Type: ACL; Schema: -; Owner: lmullen
--

GRANT USAGE ON SCHEMA output TO law_service;
GRANT ALL ON SCHEMA output TO law_admin;
...
--
-- Name: SCHEMA to_delete; Type: ACL; Schema: -; Owner: lmullen
--

GRANT USAGE ON SCHEMA to_delete TO law_service;
GRANT ALL ON SCHEMA to_delete TO law_admin;
...
--
-- Name: TABLE moml_citations; Type: ACL; Schema: output; Owner: lmullen
--

GRANT SELECT ON TABLE output.moml_citations TO law_service;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE output.moml_citations TO law_admin;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE output.moml_citations TO kfunk;


--
-- Name: TABLE moml_01_clean_cites_agg; Type: ACL; Schema: linking; Owner: lmullen
--

GRANT SELECT ON TABLE linking.moml_01_clean_cites_agg TO law_service;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE linking.moml_01_clean_cites_agg TO law_admin;


--
-- Name: TABLE moml_02_nominate_vols; Type: ACL; Schema: linking; Owner: lmullen
--

GRANT SELECT ON TABLE linking.moml_02_nominate_vols TO law_service;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE linking.moml_02_nominate_vols TO law_admin;


--
-- Name: TABLE moml_03_link_cite; Type: ACL; Schema: linking; Owner: lmullen
--

GRANT SELECT ON TABLE linking.moml_03_link_cite TO law_service;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE linking.moml_03_link_cite TO law_admin;


--
-- Name: TABLE moml_04_cap_case; Type: ACL; Schema: linking; Owner: lmullen
--

GRANT SELECT ON TABLE linking.moml_04_cap_case TO law_service;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE linking.moml_04_cap_case TO law_admin;


--
-- Name: TABLE moml_05_moml_to_cap; Type: ACL; Schema: linking; Owner: lmullen
--

GRANT SELECT ON TABLE linking.moml_05_moml_to_cap TO law_service;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE linking.moml_05_moml_to_cap TO law_admin;


--
-- Name: TABLE moml_06_treatise_to_case; Type: ACL; Schema: linking; Owner: lmullen
--

GRANT SELECT ON TABLE linking.moml_06_treatise_to_case TO law_service;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE linking.moml_06_treatise_to_case TO law_admin;
...
--
-- Name: TABLE schools_to_cases; Type: ACL; Schema: networks; Owner: lmullen
--

GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE networks.schools_to_cases TO kfunk;


--
-- Name: TABLE schools_to_textbooks; Type: ACL; Schema: networks; Owner: lmullen
--

GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE networks.schools_to_textbooks TO kfunk;


--
-- Name: TABLE treatise_bibliocouple; Type: ACL; Schema: networks; Owner: lmullen
--

GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE networks.treatise_bibliocouple TO kfunk;


--
-- Name: TABLE top_reporters; Type: ACL; Schema: output; Owner: lmullen
--

GRANT SELECT ON TABLE output.top_reporters TO law_service;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE output.top_reporters TO law_admin;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE output.top_reporters TO kfunk;


--
-- Name: TABLE top_reporters_not_whitelisted; Type: ACL; Schema: output; Owner: lmullen
--

GRANT SELECT ON TABLE output.top_reporters_not_whitelisted TO law_service;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE output.top_reporters_not_whitelisted TO law_admin;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE output.top_reporters_not_whitelisted TO kfunk;
...
--
-- Name: TABLE reporters_citation_to_cap_bak; Type: ACL; Schema: to_delete; Owner: lmullen
--

GRANT SELECT ON TABLE to_delete.reporters_citation_to_cap_bak TO law_service;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE to_delete.reporters_citation_to_cap_bak TO law_admin;
...
--
-- Name: DEFAULT PRIVILEGES FOR TABLES; Type: DEFAULT ACL; Schema: networks; Owner: lmullen
--

ALTER DEFAULT PRIVILEGES FOR ROLE lmullen IN SCHEMA networks GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLES TO kfunk;


--
-- Name: DEFAULT PRIVILEGES FOR TABLES; Type: DEFAULT ACL; Schema: output; Owner: lmullen
--

ALTER DEFAULT PRIVILEGES FOR ROLE lmullen IN SCHEMA output GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLES TO kfunk;
