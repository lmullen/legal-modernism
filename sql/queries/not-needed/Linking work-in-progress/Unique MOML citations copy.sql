--CREATE TABLE output.moml_cases_cited_citations_top AS
SELECT cases_cited.volume, cases_cited.reporter_standard, cases_cited.page, cases_cited.n, cases_cited.cleaner_cite, cases_cited.cleaner_cite AS corrected_cite,
cap_cites.case AS case_id
FROM (
SELECT cites.volume, clean.reporter_standard, cites.page, COUNT(*) AS n,
