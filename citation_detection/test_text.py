test_text_0 = "The District Court found that the States were likely to succeed on the merits of at least one of their claims and entered a \
...
test_text_1 = "The question raised and decided in Oakley v. Aspinwall, 3 Comst. 547, 9 L. O. 45 as to the effect of a judge taking part in the proceedings,"
# Henry Whittaker, Practice and Pleading Under the Codes, Original and Amended (1852)

test_text_2 = "from bed and board only. (M'Intosh v. M'Intosh, sp. t., 12 How. 289; Smith v. Smith, 4 Paige, 92;" 
...
test_text_3 = "see Code, § 129, 167; Phillips v. Gorham, 17 N. Y. 274"
# John L. Tillinghast, Practice, Pleadings, and Forms in Civil Actions in Courts of Record in the State of New York, 74 (2nd ed. 1865)

test_text_4 = "Congress’ purpose as reflected in the language of the Clean Water Act is to “ ‘restore and maintain the . . . integrity of the Nation’s waters,’ ” \
